...
class QWIDGETS_EXPORT QLongLongValidator : public QValidator
{
    Q_OBJECT
...
public:
    ...
    QLongLongValidator(qlonglong bottom, qlonglong top, QObject * parent = 0);
    ~QLongLongValidator();
...
// ----------------------------------------------------------------------------
class QWIDGETS_EXPORT QULongLongValidator : public QValidator
{
    Q_OBJECT
...
public:
    explicit QULongLongValidator(QObject * parent = 0);
