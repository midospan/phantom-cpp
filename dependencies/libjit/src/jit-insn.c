...
void jit_insn_get_code_location( jit_insn_t insn, unsigned short* start_line, unsigned short* start_column, unsigned short* end_line, unsigned short* end_column) JIT_NOTHROW
{
    if(start_line)
        *start_line = insn->code_location.start_line;
    if(start_column)
        *start_column = insn->code_location.start_column;
    if(end_line)
        *end_line = insn->code_location.end_line;
    if(end_column)
        *end_column = insn->code_location.end_column;
}
