...
_jit_block_add_insn(jit_block_t block)
{
    ...
    owner_func = jit_block_get_function(block);
    jit_function_get_current_code_location(owner_func, &block->insns[block->num_insns].code_location.start_line
        , &block->insns[block->num_insns].code_location.start_column
        , &block->insns[block->num_insns].code_location.end_line
        , &block->insns[block->num_insns].code_location.end_column);
