...
void 
jit_function_set_compilation_success_callback( jit_function_t func, jit_function_compilation_success_callback cb) JIT_NOTHROW
{
    func->compilation_success_callback = cb;
}

jit_function_insn_compilation_callback_t jit_function_get_insn_compilation_callback( jit_function_t func ) 
{
    return func->insn_compilation_callback;
}

void jit_function_set_insn_compilation_callback( jit_function_t func, jit_function_insn_compilation_callback_t cb) 
{
    func->insn_compilation_callback = cb;
}

void jit_function_set_current_code_location( jit_function_t func, unsigned short start_line, unsigned short start_column, unsigned short end_line, unsigned short end_column ) JIT_NOTHROW
{
    func->current_code_location_start_line = start_line;
    func->current_code_location_start_column = start_column;
    func->current_code_location_end_line = end_line;
    func->current_code_location_end_column = end_column;
}

void jit_function_get_current_code_location( jit_function_t func, unsigned short* start_line, unsigned short* start_column, unsigned short* end_line, unsigned short* end_column ) JIT_NOTHROW
{
    *start_line =   func->current_code_location_start_line;
    *start_column = func->current_code_location_start_column;
    *end_line =     func->current_code_location_end_line;
    *end_column =   func->current_code_location_end_column;
}