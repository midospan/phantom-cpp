...
#endif
    jit_function_compilation_success_callback compilation_success_callback;
    jit_function_insn_compilation_callback_t insn_compilation_callback;
    
    unsigned short current_code_location_start_line;
    unsigned short current_code_location_start_column;
    unsigned short current_code_location_end_line;
    unsigned short current_code_location_end_column;
};
