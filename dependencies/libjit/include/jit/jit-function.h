...
typedef void (*jit_function_compilation_success_callback)(jit_function_t);
...
int jit_function_compile_naked(jit_function_t func) JIT_NOTHROW;
...
int jit_function_compile_entry_naked(jit_function_t func, void **entry_point) JIT_NOTHROW;
...
void jit_function_set_compilation_success_callback(jit_function_t func, jit_function_compilation_success_callback cb) JIT_NOTHROW;

typedef void (*jit_function_insn_compilation_callback_t)(jit_insn_t insn, unsigned char* start_address, unsigned char* end_address);

void jit_function_set_insn_compilation_callback(jit_function_t func, jit_function_insn_compilation_callback_t cb) JIT_NOTHROW;
jit_function_insn_compilation_callback_t jit_function_get_insn_compilation_callback(jit_function_t func) JIT_NOTHROW;
