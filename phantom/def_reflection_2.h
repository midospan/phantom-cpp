...
class o_PP_CAT(_name_,__LINE__) \
    ...
    o_PP_CAT(_name_,__LINE__)()\
        ...
        , phantom::reflection::native::TNativeSignatureProvider<PHANTOM_CODEGEN_reflection_counter_value, _type_ ()>::CreateSignature() \
        ...
        , phantom::reflection::native::TNativeSignatureProvider<PHANTOM_CODEGEN_reflection_counter_value, void (_type_)>::CreateSignature() \
...
class o_PP_CAT(member_function,__LINE__) \
        ...
        o_PP_CAT(member_function,__LINE__)() \
            ...
            o_PP_QUOTE(_name_) \
            , phantom::reflection::native::TNativeSignatureProvider<PHANTOM_CODEGEN_reflection_counter_value, _returntype_ _parameterslist_>::CreateSignature() \
            , &phantom_proxy_generator_reflection_proxy_type::_name_ \
            ,phantom::detail::int_embedder<__VA_ARGS__>::value);\
...
class o_PP_CAT(o_global_value_Type,__LINE__) \
        ...
        o_PP_CAT(o_global_value_Type,__LINE__)() \
            {\
            auto pConstructor = o_proxy_new(phantom::reflection::Constructor, phantom::reflection::native::TNativeConstructor<phantom_proxy_generator_reflection_self_type _parameterslist_>)(o_PP_QUOTE(o_local_value_ShortType), \
            , phantom::reflection::native::TNativeSignatureProvider<PHANTOM_CODEGEN_reflection_counter_value, _returntype_ _parameterslist_>::CreateSignature(),phantom::detail::int_embedder<__VA_ARGS__>::value);\
