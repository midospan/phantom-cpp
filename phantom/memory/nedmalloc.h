...
#if (__cplusplus > 199711L || defined(HAVE_CPP0X)) && o_COMPILER != o_COMPILER_CLANG /* Do we have C++0x? (+CLANG bug don't kwow why...)*/
...
#    define NEDMALLOC_DLL_EXPORTS
 ...
 #else
    #ifdef _MSC_VER
        #define NEDMALLOCEXTSPEC extern __declspec(dllimport)
    #else
...
namespace nedpolicy {
    ...
    {
        template<typename Base> class policy : public Base
        {
            template<typename implementation> friend class nedallocatorI::baseimplementation;
        protected:
...
namespace nedpolicy {
    ...
    */
    template<typename Base> class empty : public Base
    {
    };
}
...
namespace nedallocatorI
{
    ...
    template<typename Base, template<typename> class... policies> class policycompositor
    {
    public:
    ...
    template<typename Impl,
            template<typename> class A=nedpolicy::empty,
            template<typename> class B=nedpolicy::empty,
            template<typename> class C=nedpolicy::empty,
            template<typename> class D=nedpolicy::empty,
            template<typename> class E=nedpolicy::empty,
            template<typename> class F=nedpolicy::empty,
            template<typename> class G=nedpolicy::empty,
            template<typename> class H=nedpolicy::empty,
            template<typename> class I=nedpolicy::empty,
            template<typename> class J=nedpolicy::empty,
            template<typename> class K=nedpolicy::empty,
            template<typename> class L=nedpolicy::empty,
            template<typename> class M=nedpolicy::empty,
            template<typename> class N=nedpolicy::empty,
            template<typename> class O=nedpolicy::empty
...
#endif
    template<typename Impl> class policycompositor<Impl>
    {
    public:
        typedef Impl value;
    };
...
#else
    template<typename> class policy1=nedpolicy::empty,
    template<typename> class policy2=nedpolicy::empty,
    template<typename> class policy3=nedpolicy::empty,
    template<typename> class policy4=nedpolicy::empty,
    template<typename> class policy5=nedpolicy::empty,
    template<typename> class policy6=nedpolicy::empty,
    template<typename> class policy7=nedpolicy::empty,
    template<typename> class policy8=nedpolicy::empty,
    template<typename> class policy9=nedpolicy::empty,
    template<typename> class policy10=nedpolicy::empty,
    template<typename> class policy11=nedpolicy::empty,
    template<typename> class policy12=nedpolicy::empty,
    template<typename> class policy13=nedpolicy::empty,
    template<typename> class policy14=nedpolicy::empty,
    template<typename> class policy15=nedpolicy::empty
#endif
> class nedallocator;
...
namespace nedallocatorI
{
    ...
    template<typename implementation> class baseimplementation
    {
    ...
    template<typename T,
        ...
        template<typename> class policy3,
        template<typename> class policy4,
        template<typename> class policy5,
        template<typename> class policy6,
        template<typename> class policy7,
        template<typename> class policy8,
        template<typename> class policy9,
        template<typename> class policy10,
        template<typename> class policy11,
        template<typename> class policy12,
        template<typename> class policy13,
        template<typename> class policy14,
        template<typename> class policy15
#endif
...
namespace nedallocatorI {
    ...
    template<typename T, typename allocator> struct PtrHolder
    {
        T *mem;
...
*/
#ifdef HAVE_CPP0XVARIADICTEMPLATES
template<typename T, typename allocator=nedallocator<T>, typename... Parameters> inline T *New(const Parameters&... parameters)
#else
template<typename T, typename allocator> inline T *New()
#endif
{
    allocator &a=nedallocatorI::StaticAllocator<allocator>::get();
...
template<typename T, typename allocator, NEDMALLOC_NEWIMPLTYPES> inline T *New(NEDMALLOC_NEWIMPLPARSDEFS) \
{ \
    allocator &a=nedallocatorI::StaticAllocator<allocator>::get(); \
    nedallocatorI::PtrHolder<T, allocator> ret(a.allocate(sizeof(T))); \
    if(*ret) \
...
*/
template<typename allocator, typename T> inline void Delete(const T *_obj)
{
