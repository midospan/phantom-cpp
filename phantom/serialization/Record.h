...
protected:
    ...
    void typesAboutToBeReplaced(reflection::Module* a_pModule, const vector<reflection::Type*>& a_Types);
    void typesReplaced(reflection::Module* a_pModule, const vector<reflection::Type*>& a_Types);
