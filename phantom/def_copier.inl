...
struct default_copier : public default_copier_helper<t_Ty,
    (has_copy_disabled_cascade<t_Ty>::value OR !boost::is_copy_constructible<t_Ty>::value OR boost::is_abstract<t_Ty>::value OR !std::is_default_constructible<t_Ty>::value)
