...
#include <phantom/reflection/runtime/JitAddressable.h>
/* **************** Declarations ***************** */
/* *********************************************** */

o_namespace_begin(phantom, reflection, runtime)

class o_runtime_export JitLocalVariable : public LocalVariable, public JitAddressable
{
...
o_classNS((phantom, reflection, runtime), JitLocalVariable, (LocalVariable, JitAddressable))
{
    o_reflection
    {
...
o_exposeN((phantom, reflection, runtime), JitLocalVariable);
