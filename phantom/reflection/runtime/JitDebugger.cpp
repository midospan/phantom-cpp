...
#include "hwbrk.h"
/* *********************************************** */
o_registerN((phantom, reflection, runtime), JitDebugger);
...
__declspec(naked) void phantom_moon_script_DebugDataBase_builtInBreak()
{
    ...
    phantom::reflection::runtime::JitDebugger::Instance()->handleSoftwareBreakPoint(0);
...
void JitDebugger::applyStepOver()
{
    ...
    m_StepByStepMethod = m_pCurrentMethod;*/
...
void JitDebugger::enableMethodEntryBreakPoint( Subroutine* a_pSubroutine )
{
