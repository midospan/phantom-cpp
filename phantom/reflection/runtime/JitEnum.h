#ifndef o_phantom_reflection_runtime_JitEnum_h__
#define o_phantom_reflection_runtime_JitEnum_h__
...
class o_runtime_export JitEnum : public Enum
{
public:
...
o_classNS((phantom, reflection, runtime), JitEnum, (Enum))
{
	o_reflection
	{
...
o_exposeN((phantom, reflection, runtime), JitEnum);
