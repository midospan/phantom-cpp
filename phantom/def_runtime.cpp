...
o_runtime_export jit_phantom_value_t jit_insn_phantom_implicit_cast( jit_function_t func, phantom::reflection::Type* a_pDestType, jit_phantom_value_t value )
{
...
o_runtime_export jit_phantom_value_t jit_phantom_math_operation_real_real( jit_function_t func, char op, jit_phantom_value_t l, jit_phantom_value_t r )
{
    switch(op)
    {
    case '+':
...
o_runtime_export jit_phantom_value_t jit_phantom_math_operation_vector2f_real( jit_function_t func, char op, jit_phantom_value_t l, jit_phantom_value_t r )
{
...
o_runtime_export jit_phantom_value_t jit_phantom_math_operation_vector2f_vector2f( jit_function_t func, char op, jit_phantom_value_t l, jit_phantom_value_t r )
{
    jit_type_t type = jit_value_get_type(l.value);
    jit_value_t result = jit_value_create(func, type);
    jit_type_t componentType = jit_type_get_field(type, 0);
...
o_runtime_export jit_phantom_value_t jit_phantom_math_operation_vector3f_real( jit_function_t func, char op, jit_phantom_value_t l, jit_phantom_value_t r )
{
    jit_type_t type = jit_value_get_type(l.value);
    jit_value_t result = jit_value_create(func, type);
    jit_type_t componentType = jit_type_get_field(type, 0);
...
o_runtime_export jit_phantom_value_t jit_phantom_math_operation_vector3f_vector3f( jit_function_t func, char op, jit_phantom_value_t l, jit_phantom_value_t r )
{
    jit_type_t type = jit_value_get_type(l.value);
...
o_runtime_export jit_phantom_value_t jit_phantom_math_operation_vector4f_real( jit_function_t func, char op, jit_phantom_value_t l, jit_phantom_value_t r )
{
    jit_type_t type = jit_value_get_type(l.value);
    jit_value_t result = jit_value_create(func, type);
    jit_type_t componentType = jit_type_get_field(type, 0);
...
o_runtime_export jit_phantom_value_t jit_phantom_math_operation_vector4f_vector4f( jit_function_t func, char op, jit_phantom_value_t l, jit_phantom_value_t r )
{
    jit_type_t type = jit_value_get_type(l.value);
    jit_value_t result = jit_value_create(func, type);
    jit_type_t componentType = jit_type_get_field(type, 0);
...
o_runtime_export jit_phantom_value_t jit_phantom_math_operation_vector2f_any( jit_function_t func, char op, jit_phantom_value_t l, jit_phantom_value_t r )
{
...
o_runtime_export jit_phantom_value_t jit_phantom_math_operation_vector3f_any( jit_function_t func, char op, jit_phantom_value_t l, jit_phantom_value_t r )
{
    if(r.type->isIntegralType() || r.type->asEnum() || r.type->isArithmeticType())
    {
...
o_runtime_export jit_phantom_value_t jit_phantom_math_operation_vector4f_any( jit_function_t func, char op, jit_phantom_value_t l, jit_phantom_value_t r )
{
    if(r.type->isIntegralType() || r.type->asEnum() || r.type->isArithmeticType())
    {
...
o_runtime_export jit_phantom_value_t jit_phantom_math_operation_real_any( jit_function_t func, char op, jit_phantom_value_t l, jit_phantom_value_t r )
{
    if(r.type->isIntegralType() || r.type->asEnum() || r.type->isArithmeticType())
    {
...
o_runtime_export jit_phantom_value_t jit_phantom_math_unary_intrinsic_float32( jit_function_t func, const char* intrinsic, jit_phantom_value_t operand )
{
...
o_runtime_export jit_phantom_value_t jit_phantom_math_unary_intrinsic_float64( jit_function_t func, const char* intrinsic, jit_phantom_value_t operand )
{
...
o_runtime_export jit_phantom_value_t jit_phantom_math_binary_intrinsic_float32_float32( jit_function_t func, const char* intrinsic, jit_phantom_value_t l, jit_phantom_value_t r)
{
...
o_runtime_export jit_phantom_value_t jit_phantom_math_binary_intrinsic_float64_float64( jit_function_t func, const char* intrinsic, jit_phantom_value_t l, jit_phantom_value_t r )
{
...
o_runtime_export jit_phantom_value_t jit_phantom_math_func_vector2f( jit_function_t func, const char* function, jit_phantom_value_t* args )
{
...
o_runtime_export jit_phantom_value_t jit_phantom_math_func_vector2f_vector2f( jit_function_t func, const char* function, jit_phantom_value_t args[2] )
{
...
o_runtime_export jit_phantom_value_t jit_phantom_math_func_vector2f_vector2f_float( jit_function_t func, const char* function, jit_phantom_value_t args[3] )
{
...
o_runtime_export jit_phantom_value_t jit_phantom_math_func(jit_function_t func, const char* function, jit_phantom_value_t value)
{
...
o_runtime_export jit_phantom_value_t jit_phantom_math_func(jit_function_t func, const char* function, jit_phantom_value_t l, jit_phantom_value_t r)
{
