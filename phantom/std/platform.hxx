...
(
        ...
        o_data_member(_Nodeptr, _Myhead, o_no_range, o_protected_access);	// pointer to head node
        o_data_member(size_type, _Mysize, o_no_range, o_protected_access);	// number of elements
);
