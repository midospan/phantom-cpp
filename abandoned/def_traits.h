...
template<typename t_Ty, int index>
struct super_class_of_;

template<typename t_Ty>
struct super_class_count_of_;
...
template<typename t_Ty, int, bool>
struct destroyed_signal_emitter_helper_;

template<typename t_Ty>
struct destroyed_signal_emitter_;

template<typename t_Ty>
struct has_virtual_destructor_cascade_;
...
template<typename t_Ty>
struct is_default_constructible_and_not_abstract_;
...
template<typename t_Ty>
struct is_default_constructible_and_not_abstract_ 
    : public is_default_constructible_and_not_abstract_helper<t_Ty, boost::is_abstract<t_Ty>::value>
{
...
template<typename t_Ty>
struct has_deferred_cpp_reflection_
{
    const static bool value = false;
};
...
template<typename t_Ty>
struct super_class_count_of_ : public super_class_count_of_helper<t_Ty>{};

template<typename t_Ty, typename t_Super>
struct super_class_index_of_  : public super_class_index_of_helper<t_Ty,t_Super>{};

template<typename t_Ty, typename t_DTy>
struct super_statechart_ : public super_statechart_helper<t_Ty,t_DTy>{};

template<typename t_Ty>
struct is_meta_type_
{
...
template<typename t_Ty>
struct has_statechart_cascade_
    : public has_statechart_cascade_helper_<t_Ty, super_class_count_of<t_Ty>::value>
{
};

template<typename t_Ty>
struct has_root_statechart_
{
...
template<typename t_Ty>
struct first_super_statechart_class_of_
  : public first_super_statechart_class_of_helper_
  <
    t_Ty
...
struct first_super_statechart_class_of_helper_<t_Ty, t_has_statechart, true>
  ...
  t_Ty
  , super_class_count_of_<t_Ty>::value>
{
};
...
struct first_super_statechart_class_of_helper_super_
  ...
  , has_statechart_cascade_<
  o_NESTED_TYPE super_class_of<t_Ty, super_class_count_of_<t_Ty>::value-t_super_class_count_of>::type
  >::value >
{
...
struct first_super_statechart_class_of_helper_cascade_<t_Ty, t_super_class_count_of, true>
  : public first_super_statechart_class_of_<
...
template<typename t_Ty>
struct object_dynamic_cast_ : public object_dynamic_cast_helper<t_Ty>
{
};
...
struct super_class_of_ : public super_class_of_helper<t_Ty,t_index>
{
};
...
struct has_virtual_destructor_cascade_helper_
{
    const static boolean value = boost::has_virtual_destructor<t_Ty>::value
        OR has_virtual_destructor_cascade_<typename super_class_of<t_Ty, t_super_class_count_of-1>::type>::value
...
template<typename t_Ty>
struct has_virtual_destructor_cascade_
    : public has_virtual_destructor_cascade_helper_<t_Ty, super_class_count_of_<t_Ty>::value>
{
...
template<typename t_Ty>
struct has_statechart_ : public has_enclosed_statechart<t_Ty>
{
...
template<typename t_Ty>
struct has_reflection_
    : public has_enclosed_reflection<t_Ty>
{
...
template<typename t_Ty>
struct has_reflection_<t_Ty*>
{
    BOOST_STATIC_CONSTANT(bool, value = has_reflection_<t_Ty>::value);
};
template<typename t_Ty>
struct has_reflection_<t_Ty&>
{
...
template<typename t_Ty>
struct has_reflection_<t_Ty const>
{
    BOOST_STATIC_CONSTANT(bool, value = has_reflection_<t_Ty>::value);
};
template<typename t_Ty, int t_super_class_count_of>
...
template<typename t_Ty>
struct has_reflection_cascade_
    : public has_reflection_cascade_helper_<t_Ty, super_class_count_of<t_Ty>::value>
{
};
...
template<typename t_Ty, typename t_DTy = t_Ty>
struct statechart_
    : public statechart_helper<t_Ty, t_DTy, has_statechart<t_Ty>::value>
{
...
template<typename t_Ty>
struct track_count_of_
    : public track_count_of_helper<t_Ty, has_statechart<t_Ty>::value>
{
};
...
template<typename t_Ty>
struct has_copy_disabled_cascade_ : public has_copy_disabled_cascade_helper_<t_Ty, super_class_count_of<t_Ty>::value>
{
...
template<typename t_Ty>
struct track_count_cascade_of_
{
...
template<typename t_Ty>
struct super_total_track_count_of_ : public super_total_track_count_of_helper<t_Ty>{};
...
template<typename t_Ty>
struct is_serializable_ : public is_default_constructible_and_not_abstract<t_Ty> {};

template<typename t_Ty>
struct is_data_pointer_  : public false_ {};

template<typename t_Ty>
struct is_data_pointer_ <t_Ty*> : public true_ {};

template<typename t_Ty>
struct is_data_pointer_ <t_Ty const*> : public true_ {};
...
#define o_traits_specialize_object_dynamic_cast_helper_1() o_traits_specialize_object_dynamic_cast_helper_0()  if(result == NULL) result = phantom::detail::object_dynamic_cast_<t_S0>::apply( a_pTargetClass, static_cast<t_S0*>(static_cast<t_Ty*>(a_pBase)) ); else return result;
#define o_traits_specialize_object_dynamic_cast_helper_2() o_traits_specialize_object_dynamic_cast_helper_1()  if(result == NULL) result = phantom::detail::object_dynamic_cast_<t_S1>::apply( a_pTargetClass, static_cast<t_S1*>(static_cast<t_Ty*>(a_pBase)) ); else return result;
#define o_traits_specialize_object_dynamic_cast_helper_3() o_traits_specialize_object_dynamic_cast_helper_2()  if(result == NULL) result = phantom::detail::object_dynamic_cast_<t_S2>::apply( a_pTargetClass, static_cast<t_S2*>(static_cast<t_Ty*>(a_pBase)) ); else return result;
#define o_traits_specialize_object_dynamic_cast_helper_4() o_traits_specialize_object_dynamic_cast_helper_3()  if(result == NULL) result = phantom::detail::object_dynamic_cast_<t_S3>::apply( a_pTargetClass, static_cast<t_S3*>(static_cast<t_Ty*>(a_pBase)) ); else return result;
#define o_traits_specialize_object_dynamic_cast_helper_5() o_traits_specialize_object_dynamic_cast_helper_4()  if(result == NULL) result = phantom::detail::object_dynamic_cast_<t_S4>::apply( a_pTargetClass, static_cast<t_S4*>(static_cast<t_Ty*>(a_pBase)) ); else return result;
#define o_traits_specialize_object_dynamic_cast_helper_6() o_traits_specialize_object_dynamic_cast_helper_5()  if(result == NULL) result = phantom::detail::object_dynamic_cast_<t_S5>::apply( a_pTargetClass, static_cast<t_S5*>(static_cast<t_Ty*>(a_pBase)) ); else return result;
#define o_traits_specialize_object_dynamic_cast_helper_7() o_traits_specialize_object_dynamic_cast_helper_6()  if(result == NULL) result = phantom::detail::object_dynamic_cast_<t_S6>::apply( a_pTargetClass, static_cast<t_S6*>(static_cast<t_Ty*>(a_pBase)) ); else return result;
#define o_traits_specialize_object_dynamic_cast_helper_8() o_traits_specialize_object_dynamic_cast_helper_7()  if(result == NULL) result = phantom::detail::object_dynamic_cast_<t_S7>::apply( a_pTargetClass, static_cast<t_S7*>(static_cast<t_Ty*>(a_pBase)) ); else return result;
#define o_traits_specialize_object_dynamic_cast_helper_9() o_traits_specialize_object_dynamic_cast_helper_8()  if(result == NULL) result = phantom::detail::object_dynamic_cast_<t_S8>::apply( a_pTargetClass, static_cast<t_S8*>(static_cast<t_Ty*>(a_pBase)) ); else return result;
#define o_traits_specialize_object_dynamic_cast_helper_10() o_traits_specialize_object_dynamic_cast_helper_9() if(result == NULL) result = phantom::detail::object_dynamic_cast_<t_S9>::apply( a_pTargetClass, static_cast<t_S9*>(static_cast<t_Ty*>(a_pBase)) ); else return result;
...
#define o_traits_specialize_super_traitS(_trait_,_name_, _supers_)\
    o_namespace_begin(phantom,detail)\
    template<>\
    struct _trait_##_< ::_name_> \
    : public _trait_##_helper< ::_name_, o_PP_IDENTITY _supers_> {};\
...
#define o_traits_specialize_super_traitTTS(_trait_, _template_types_ , _template_params_, _name_, _supers_)\
    o_namespace_begin(phantom,detail)\
    template<o_PP_MIX(_template_types_,_template_params_)>\
    struct _trait_##_ < ::_name_ < o_PP_IDENTITY _template_params_ > >\
    : public _trait_##_helper< ::_name_ < o_PP_IDENTITY _template_params_ >, o_PP_IDENTITY _supers_> {};\
    o_namespace_end(phantom,detail)

#define o_traits_specialize_super_traitCTTS(_trait_, _classes_, _template_types_ , _template_params_, _name_, _supers_)\
    o_namespace_begin(phantom,detail)\
    template<o_PP_MIX(_template_types_,_template_params_)>\
struct _trait_##_ < o_PP_CREATE_QUALIFIED_NAME(_classes_,_name_) < o_PP_IDENTITY _template_params_ > >\
    : public _trait_##_helper< o_PP_CREATE_QUALIFIED_NAME(_classes_,_name_) < o_PP_IDENTITY _template_params_ >, o_PP_IDENTITY _supers_> {};\
    o_namespace_end(phantom,detail)

#define o_traits_specialize_super_traitN(_trait_,_namespaces_,_name_)\
    o_namespace_begin(phantom,detail)\
    template<>\
    struct _trait_##_< o_PP_CREATE_QUALIFIED_NAME(_namespaces_,_name_)> \
...
#define o_traits_specialize_super_traitNTT(_trait_,_namespaces_, _template_types_ , _template_params_, _name_)\
    o_namespace_begin(phantom,detail)\
    template<o_PP_MIX(_template_types_,_template_params_)>\
    struct _trait_##_ < o_PP_CREATE_QUALIFIED_NAME(_namespaces_,_name_) < o_PP_IDENTITY _template_params_ > >\
...
#define o_traits_specialize_super_traitNCTT(_trait_,_namespaces_, _classes_, _template_types_ , _template_params_, _name_)\
    o_namespace_begin(phantom,detail)\
    template<o_PP_MIX(_template_types_,_template_params_)>\
struct _trait_##_ < o_PP_CREATE_QUALIFIED_NAME_2(_namespaces_,_classes_,_name_) < o_PP_IDENTITY _template_params_ > >\
    : public :: o_PP_CREATE_SCOPE _namespaces_ :: _name_##_super_namespace_solver< o_PP_IDENTITY _template_params_ >::_trait_##_____{};\
    o_namespace_end(phantom,detail)
...
struct _trait_##_< ::_name_,_exP_> \
    : public _trait_##_helper< ::_name_, _exP_, o_PP_IDENTITY _supers_> {};\
    o_namespace_end(phantom,detail)
...
struct _trait_##_ < ::_name_ < o_PP_IDENTITY _template_params_ >, _exP_ > \
    : public _trait_##_helper< ::_name_< o_PP_IDENTITY _template_params_ >, _exP_, o_PP_IDENTITY _supers_> {};\
    o_namespace_end(phantom,detail)
...
#define o_traits_specialize_super_traitexCTTS(_trait_,_exT_,_exP_, _classes_, _template_types_ , _template_params_, _name_, _supers_)\
    o_namespace_begin(phantom,detail)\
    template<o_PP_MIX(_template_types_,_template_params_), _exT_ _exP_>\
struct _trait_##_ < o_PP_CREATE_QUALIFIED_NAME(_classes_,_name_) < o_PP_IDENTITY _template_params_ >, _exP_ > \
    : public _trait_##_helper< o_PP_CREATE_QUALIFIED_NAME(_classes_,_name_)< o_PP_IDENTITY _template_params_ >, _exP_, o_PP_IDENTITY _supers_> {};\
    o_namespace_end(phantom,detail)

#define o_traits_specialize_super_traitexN(_trait_,_exT_,_exP_,_namespaces_,_name_)\
    o_namespace_begin(phantom,detail)\
    template<_exT_ _exP_>\
struct _trait_##_< o_PP_CREATE_QUALIFIED_NAME(_namespaces_,_name_), _exP_ > \
...
#define o_traits_specialize_super_traitexNTT(_trait_,_exT_,_exP_,_namespaces_, _template_types_ , _template_params_, _name_)\
    o_namespace_begin(phantom,detail)\
    template<o_PP_MIX(_template_types_,_template_params_), _exT_ _exP_>\
struct _trait_##_ < o_PP_CREATE_QUALIFIED_NAME(_namespaces_,_name_) < o_PP_IDENTITY _template_params_ >, _exP_ > \
...
#define o_traits_specialize_super_traitexNCTT(_trait_,_exT_,_exP_,_namespaces_, _classes_, _template_types_ , _template_params_, _name_)\
    o_namespace_begin(phantom,detail)\
    template<o_PP_MIX(_template_types_,_template_params_), _exT_ _exP_>\
struct _trait_##_ < o_PP_CREATE_QUALIFIED_NAME_2(_namespaces_,_classes_,_name_) < o_PP_IDENTITY _template_params_ >, _exP_ > \
    : public :: o_PP_CREATE_SCOPE _namespaces_ :: _name_##_super_namespace_solver< o_PP_IDENTITY _template_params_ >::o_NESTED_TEMPLATE _trait_##_____<_exP_> {};\
    o_namespace_end(phantom,detail)
...
#define o_traits_specializeC(_trait_,_value_,_classes_,_name_)\
    o_namespace_begin(phantom, detail) \
    template<>\
struct _trait_##_< o_PP_CREATE_QUALIFIED_NAME(_classes_,_name_) >\
{\
    o_PP_IDENTITY _value_;\
};\
    o_namespace_end(phantom, detail)
...
#define o_traits_specializeNC(_trait_,_value_,_namespaces_,_classes_,_name_)\
    o_namespace_begin(phantom, detail) \
    template<>\
struct _trait_##_< o_PP_CREATE_QUALIFIED_NAME_2(_namespaces_,_classes_,_name_) >\
{\
    o_PP_IDENTITY _value_;\
};\
    o_namespace_end(phantom, detail)
...
template<typename t_Ty>
struct has_reflection : public detail::has_reflection_<t_Ty> {};

template<typename t_Ty>
struct has_statechart : public detail::has_statechart_<t_Ty> {};

template<typename t_Ty>
struct has_statechart_cascade : public detail::has_statechart_cascade_<t_Ty> {};

template<typename t_Ty>
struct has_super_statechart_cascade : public detail::has_super_statechart_cascade_<t_Ty> {};

template<typename t_Ty>
struct proxy_of : public detail::proxy_of_<t_Ty> {};

template<typename t_Ty>
struct is_root_class : public detail::is_root_class_<t_Ty> {};

template<typename t_Ty>
struct is_root_type : public detail::is_root_type_<t_Ty> {};

template<typename t_Ty>
struct destroyed_signal_emitter : public detail::destroyed_signal_emitter_<t_Ty> {};

template<typename t_Ty>
struct has_root_statechart : public detail::has_root_statechart_<t_Ty> {};

template<typename t_Ty>
struct first_super_statechart_class_of : public detail::first_super_statechart_class_of_<t_Ty> {};

template<typename t_Ty>
struct meta_specifiers : public detail::meta_specifiers_<t_Ty> {};
...
template<typename t_Ty>
struct is_meta_type : public detail::is_meta_type_<t_Ty> {};
...
o_create_has_method_const_0(PHANTOM_CODEGEN_destroyed)
o_create_has_method_2(PHANTOM_CODEGEN_restore)

template<typename t_Ty, bool t_is_class>
struct has_destroyed_signal_helper : public has_method_PHANTOM_CODEGEN_destroyed<t_Ty,phantom::signal_t()>
{

};

template<typename t_Ty>
struct has_destroyed_signal_helper<t_Ty, false> : public detail::false_ {};

template<typename t_Ty>
struct has_destroyed_signal
    : public has_destroyed_signal_helper<t_Ty, boost::is_class<t_Ty>::value>
{

};

// RESTORE METHOD EXISTENCE

template<typename t_Ty>
struct has_initializer_method_restore
    : public has_method_PHANTOM_CODEGEN_restore<t_Ty, phantom::boolean(phantom::uint,phantom::uint)>
{
...
struct has_initializer_method_restore_declared_helper
{
    ...
    static yes deduce(phantom::boolean (t_Ty::*)(phantom::uint,phantom::uint));
    static no deduce(phantom::boolean (super_class ::*)(phantom::uint,phantom::uint));
...
template<typename t_Ty>
struct has_deferred_cpp_reflection : public detail::has_deferred_cpp_reflection_<t_Ty> {};

template<typename t_Ty>
struct is_template : public detail::is_template_<t_Ty> {};

template<typename t_Ty, int index>
struct super_class_of : public detail::super_class_of_<t_Ty, index>{};
...
template<typename t_Ty>
struct has_virtual_destructor_cascade : public detail::has_virtual_destructor_cascade_<t_Ty>{};

template<typename t_Ty>
struct super_class_count_of : public detail::super_class_count_of_<t_Ty>{};

template<typename t_Ty>
struct has_reflection_cascade : public detail::has_reflection_cascade_<t_Ty> {};

template<typename t_Ty, typename t_STy = t_Ty>
struct super_statechart : public detail::super_statechart_<t_Ty,t_STy> {};

template<typename t_Ty>
struct super_total_track_count_of : detail::super_total_track_count_of_<t_Ty> {};

template<typename t_Ty>
struct object_dynamic_cast : detail::object_dynamic_cast_<t_Ty> {};

template<typename t_BaseTy, typename t_Ty>
struct statechart : public detail::statechart_<t_BaseTy, t_Ty> {};

template<typename t_Ty>
struct track_count_of : public detail::track_count_of_<t_Ty> {};

template<typename t_Ty>
struct track_count_cascade_of: public detail::track_count_cascade_of_<t_Ty> {};

template<typename t_Ty>
struct has_copy_disabled : public detail::has_copy_disabled_<t_Ty> {};

template<typename t_Ty>
struct has_copy_disabled_cascade : public detail::has_copy_disabled_cascade_<t_Ty> {};

template<typename t_Ty>
struct is_serializable : public detail::is_serializable_<t_Ty> {};

template<typename t_Ty>
struct is_data_pointer : public detail::is_data_pointer_<t_Ty> {};

template<typename t_Ty>
struct is_default_constructible_and_not_abstract : public detail::is_default_constructible_and_not_abstract_<t_Ty> {};
