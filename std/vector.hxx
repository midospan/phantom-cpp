...
o_protected:
    o_data_member(pointer, _Myfirst);	// pointer to beginning of array
    o_data_member(pointer, _Mylast);	// pointer to current end of sequence
    o_data_member(pointer, _Myend);	// pointer to end of array
);
