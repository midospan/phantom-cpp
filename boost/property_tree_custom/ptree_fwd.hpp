...
// ----------------------------------------------------------------------------
#ifndef BOOST_PROPERTY_TREE_CUSTOM_PTREE_FWD_HPP_INCLUDED
#define BOOST_PROPERTY_TREE_CUSTOM_PTREE_FWD_HPP_INCLUDED
...
namespace boost { namespace property_tree_custom
{
    ...
    template < class Key, class Data, class Alloc, class StrAlloc = std::allocator<char>, class KeyCompare = std::less<Key> >
    class basic_ptree;
    ...
    template<typename Str> class ptree_error;
    template<typename Str> class ptree_bad_data;
    template<typename Str> class ptree_bad_path;
     ...
     * comparison.
     */
    typedef basic_ptree<std::basic_string<char, std::char_traits<char>, pool_allocator<char> >
						, std::basic_string<char, std::char_traits<char>, pool_allocator<char> >
						, fast_pool_allocator<char>
						, pool_allocator<char> > ptree;
     ...
     */
    typedef basic_ptree<std::wstring, std::wstring, fast_pool_allocator<wchar_t>, pool_allocator<wchar_t> > wptree;
...
#   define BOOST_PROPERTY_TREE_CUSTOM_THROW(e) BOOST_THROW_EXCEPTION(e)
#endif
