...
#ifndef BOOST_PROPERTY_TREE_CUSTOM_STRING_PATH_HPP_INCLUDED
#define BOOST_PROPERTY_TREE_CUSTOM_STRING_PATH_HPP_INCLUDED

#include <boost/property_tree_custom/ptree_fwd.hpp>
#include <boost/property_tree_custom/id_translator.hpp>
...
namespace boost { namespace property_tree_custom
{
    namespace detail
    {
        ...
        inline std::basic_string<char,std::char_traits<char>,typename Sequence::_Alloc::BOOST_NESTED_TEMPLATE rebind<char>::other> dump_sequence(const Sequence &)
        {
            return "<undumpable sequence>";
        }
		template<typename Ch, typename Traits, typename Alloc>
        inline std::basic_string<char,std::char_traits<char>,Alloc> dump_sequence(const std::basic_string<Ch,Traits,Alloc> &s)
        {
            return s;
        }
#ifndef BOOST_NO_STD_WSTRING
		template<typename Alloc>
		inline std::basic_string<char,std::char_traits<char>,typename Alloc::BOOST_NESTED_TEMPLATE rebind<char>::other> dump_sequence(const std::basic_string<wchar_t,std::char_traits<wchar_t>,Alloc> &s)
		{
    ...
    public:
        ...
        std::basic_string<char, std::char_traits<char>, typename String::allocator_type:: BOOST_NESTED_TEMPLATE rebind<char>::other>
			dump() const {
    ...
    typename Translator::external_type string_path<String, Translator>::reduce()
    {
        ...
        BOOST_PROPERTY_TREE_CUSTOM_THROW(ptree_bad_path<String>("Path syntax error", *this));
    }
