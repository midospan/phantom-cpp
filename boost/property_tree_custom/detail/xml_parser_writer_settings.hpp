...
// ----------------------------------------------------------------------------
#ifndef BOOST_PROPERTY_TREE_CUSTOM_DETAIL_XML_PARSER_WRITER_SETTINGS_HPP_INCLUDED
#define BOOST_PROPERTY_TREE_CUSTOM_DETAIL_XML_PARSER_WRITER_SETTINGS_HPP_INCLUDED
