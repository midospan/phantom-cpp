...
// ----------------------------------------------------------------------------
#ifndef BOOST_PROPERTY_TREE_CUSTOM_DETAIL_PTREE_UTILS_HPP_INCLUDED
#define BOOST_PROPERTY_TREE_CUSTOM_DETAIL_PTREE_UTILS_HPP_INCLUDED
...
namespace boost { namespace property_tree_custom { namespace detail
{
    ...
    template<class Str>
    Str narrow(const typename Str::value_type *text)
    {
        Str result;
        while (*text)
        {
