...
#ifndef BOOST_PROPERTY_TREE_CUSTOM_PTREE_HPP_INCLUDED
#define BOOST_PROPERTY_TREE_CUSTOM_PTREE_HPP_INCLUDED

#include <boost/property_tree_custom/ptree_fwd.hpp>
#include <boost/property_tree_custom/string_path.hpp>
#include <boost/property_tree_custom/stream_translator.hpp>
#include <boost/property_tree_custom/exceptions.hpp>
...
namespace boost { namespace property_tree_custom
{
     ...
     */
    template<class Key, class Data, class Alloc, class StrAlloc, class KeyCompare>
    class basic_ptree
    {
#if defined(BOOST_PROPERTY_TREE_CUSTOM_DOXYGEN_INVOKED)
    public:
#endif
        // Internal types
        /**
         ...
         */
        typedef basic_ptree<Key, Data, Alloc, StrAlloc, KeyCompare> self_type;
    ...
    public:
		...
		typedef StrAlloc							 string_allocator;
		...
		{
		public:
			typedef typename StrAlloc::BOOST_NESTED_TEMPLATE rebind<Ch>::other allocator;
			typedef std::basic_string<Ch, std::char_traits<Ch>, allocator> basic_string;
			typedef std::basic_ostream<Ch, std::char_traits<Ch> > basic_ostream;
			typedef std::basic_ofstream<Ch, std::char_traits<Ch> > basic_ofstream;
			typedef std::basic_istream<Ch, std::char_traits<Ch> > basic_istream;
			typedef std::basic_ifstream<Ch, std::char_traits<Ch> > basic_ifstream;
		};
		...
		typedef typename for_char<typename key_type::value_type>::basic_ofstream key_basic_ofstream;
		typedef typename for_char<typename key_type::value_type>::basic_ifstream key_basic_ifstream;
		typedef typename for_char<typename key_type::value_type>::basic_ostream key_basic_ostream;
		typedef typename for_char<typename key_type::value_type>::basic_istream key_basic_istream;
		typedef typename for_char<typename key_type::value_type>::basic_string key_basic_string;

		typedef typename for_char<char>::basic_string	string_type;
        ...
        typename boost::enable_if<
            ...
            typename basic_ptree<Key, Data, Alloc, StrAlloc, KeyCompare>:: BOOST_NESTED_TEMPLATE for_char<Ch>::basic_string
    >::type
        ...
        */
        ...
        typename boost::enable_if<
            detail::is_character<Ch>,
            typename for_char<Ch>::basic_string
        >::type
...
#include <boost/property_tree_custom/detail/ptree_implementation.hpp>
